...
**All the predictors are little correlated to `shares`, even the correlation .**

We may not get a very reasonable model to predict shares using these predictors. 
...
Choose a better model with smaller root mean square error (RMSE), smaller mean absolute error (MAE) and bigger R squared. 
